...
# Dataframe for plot
self_harm_chart_data <- readRDS(here("data/self-harm_egm_chart_data.rds"))

# Dataframe for table
self_harm_table_data <- readRDS(here("data/self-harm_egm_table_data.rds"))

## WEMWEBS

# Dataframe for adult plot
wemwebs_adult_chart_data <- readRDS(here("data/wemwebs_adult_chart_data.parquet"))

# Dataframe for adult table
wemwebs_adult_table_data <- readRDS(here("data/wemwebs_adult_table_data.parquet"))

# Dataframe for CYP plot
wemwebs_cyp_chart_data <- readRDS(here("data/wemwebs_cyp_chart_data.parquet"))

# Dataframe for CYP table
wemwebs_cyp_table_data <- readRDS(here("data/wemwebs_cyp_table_data.parquet"))
